...
# ============================================================
# EverSpark Forge - Bootstrap V2 cu121 profile
# Responsibility:
...
core_log_init comfyui.bootstrap.cu121 "$BOOTSTRAP_LOG"
...
main() {
  ...
  core_info bootstrap.section "EverSpark Forge Bootstrap V2 cu121 started"
  ...
  core_info bootstrap.section "EverSpark Forge Bootstrap V2 cu121 completed"
